  ...
  data: [
    {
      ...
      summary: "拒絕傳統荷比法快閃玩法！除了親訪荷蘭最重要的兩大年度盛事－每年僅舉辦一天的【荷蘭國王節】及春天限定【庫肯霍夫鬱金香花季】的百萬花海，我們還想邀請您一起走訪荷比大城小鎮：傳統與現代兼容的大都會，或典雅、或古樸的特色小鎮－荷蘭與比利時的美，很多元，值得您慢慢探索、細細品味！\n",
      ...
      policy: "◆ 航空公司座位安排：本行程全程使用『團體經濟艙』機票，不適用於出發前預先選位，也無法事先確認座位相關需求（如，靠窗、靠走道．．等），且機上座位是航空公司依照乘客英文姓名之字母順序做統一安排，因此同行者有可能無法安排在一起，敬請參團貴賓了解。",
      status: 1,
      ...
      highlights: [
        {
          ...
          title: "兩大慶典．限量甄藏",
          subtitle: "",
          content: "◆ 一年僅此一天的【荷蘭國王節】－準備好你的橙色造型，一起開趴啦！\n◆ 每年春季限時美景【庫肯霍夫鬱金香花季】－悠遊最壯觀的百萬花海！",
          order: 0,
...
export const useProductCountries = (): TUseHomeQueryResult<TRegionData[], TCountriesResponse> => {
  const query = useQuery<TRegionData[], AxiosError<TApiResponse<TRegionData[]>>>({
