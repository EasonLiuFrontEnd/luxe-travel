...
type TUseMapQueryResult = {
  query: ReturnType<typeof useQuery<TArticle[], AxiosError<TApiResponse<TArticle[]>>>>
  mock: TArticleResponse
}

const fetchMapData = async (): Promise<TArticle[]> => {
  const response = await apiClient.get<TArticleResponse>(
    '/api/admin/articles',
  )
  ...
  rows: [
    {
      ...
      title: '航向伊比利亞',
      subtitle: '葡萄牙',
      linkUrl: 'https://www.luxetravel.com.tw/TripIntroduction.aspx?TripNo=T20250124000201',
      imageUrl: 'https://okm2to3vnqmhjqm9.public.blob.vercel-storage.com/P59sSzL-iaA3gB35qKa701inNTBWRlPG5M539H.jpeg',
    ...
    },
    {
      ...
      title: '歐洲自由行線上講座',
      subtitle: 'PON哥講座',
      linkUrl: 'https://www.youtube.com/playlist?list=PLRVH5TZdmfQAGk1m0uJEQz9kVyB9ur8_h',
      imageUrl: 'https://okm2to3vnqmhjqm9.public.blob.vercel-storage.com/8B95Ttq-qEbhA6Nx0PVi5k2ShzhoOYR87hb4lD.jpeg',
    ...
    },
    {
      ...
      imageUrl: 'https://okm2to3vnqmhjqm9.public.blob.vercel-storage.com/3G8GvZ2-W0XCK8BChBWIl2tOSnU0ZCQyR6lL41.jpeg',
    ...
    },
    {
      ...
      imageUrl: 'https://okm2to3vnqmhjqm9.public.blob.vercel-storage.com/TFyZ6E4-E4b3ygsh9NmE0ektoqJR8Gg1r4ZocL.jpeg',
    ...
    },
    {
      ...
      imageUrl: 'https://okm2to3vnqmhjqm9.public.blob.vercel-storage.com/u97XhZ2-EvnGIGN9K0H7RuHJCXoiLXJWNYEYae.jpeg',
