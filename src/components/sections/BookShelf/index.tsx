...
const BookShelf = () => {
  ...
  const cardSizesMobile = [
    ...
    'w-[64px] h-[334px]',
    'w-[80px] h-[360px]',
    'w-[86.87px] h-[269.72px]',
    'w-[80px] h-[326px]',
    'w-[64px] h-[394px]',
    'w-[108.27px] h-[333.58px]',
    'w-[80px] h-[261px]',
    'w-[64px] h-[378px]',
    'w-[80px] h-[344px]',
    'w-[107.05px] h-[319.63px]',
    'w-[89.09px] h-[264.43px]',
    'w-[64px] h-[394px]',
    'w-[75.98px] h-[346.54px]',
    'w-[144px] h-[304px]',
    'w-[64px] h-[354px]',
    'w-[86.95px] h-[270.72px]',
    'w-[80px] h-[378px]',
  ]
  ...
  const cardSizesWeb = [
    ...
    'w-[80px] h-[398px]',
    'w-[104px] h-[424px]',
    'w-[108.37px] h-[334.72px]',
    'w-[104px] h-[390px]',
    'w-[80px] h-[458px]',
    'w-[137.6px] h-[397.58px]',
    'w-[104px] h-[325px]',
    'w-[80px] h-[442px]',
    'w-[104px] h-[408px]',
    'w-[136.38px] h-[383.63px]',
    'w-[115.28px] h-[328.43px]',
    'w-[80px] h-[458px]',
    'w-[94.19px] h-[410.54px]',
    'w-[200px] h-[368px]',
    'w-[80px] h-[418px]',
    'w-[108.37px] h-[334.72px]',
    'w-[104px] h-[442px]',
      ...
      >
        ...
        >
          {cards.map((c, idx) => {
            ...
            const webWidth = webSize
              .split(' ')[0]
              .replace('w-[', '')
              .replace('px]', '')
            const webHeight = webSize
              .split(' ')[1]
              .replace('h-[', '')
              .replace('px]', '')
