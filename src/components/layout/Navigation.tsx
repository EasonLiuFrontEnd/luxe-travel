...
const Navigation = ({
  ...
  return (
    <>
      ...
      <div className='p-3 pl-[28px] max-[374px]:hidden'>
      ...
      <div className='max-[374px]:flex min-[375px]:hidden w-full justify-between items-center'>
        <Logo isMobile={true} />
        <button
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M4 12H20" stroke="#BDA05E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M4 18H20" stroke="#BDA05E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M4 6H20" stroke="#BDA05E" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
        </button>
      </div>
