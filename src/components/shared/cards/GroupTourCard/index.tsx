...
import type { TTourDate } from '@/components/pages/tours/config'
        ...
        <div className='relative h-full w-full'>
          ...
          >
            ...
            <div className='absolute h-[17px] w-[64px] top-[10px] xl:top-[13px] left-1/2 transform -translate-x-1/2'>
              <Image
                key='group-tour-card-logo-desktop'
                src='/tours/logo.png'
                alt='Logo'
                width={64}
                height={17}
    ...
    >
      <div className='flex items-end relative isolate w-full'>
        ...
        <div className='relative flex flex-1 min-w-0'>
          <div className='hidden xl:block absolute bg-figma-secondary-500 bottom-0 right-0 transition-all duration-300 group-hover/tour-card:-translate-x-[40px] group-hover/tour-card:-translate-y-[36px] h-full w-full' />
            ...
            <div className='flex flex-col xl:gap-3 w-full'>
              <div className='flex items-end xl:items-start xl:justify-between w-full'>
                ...
                >
                  ...
                  >
                    ...
                    <div className='absolute h-[17px] w-[64px] top-[10px] left-1/2 transform -translate-x-1/2'>
                      <Image
                        key='group-tour-card-logo-mobile'
                        src='/tours/logo.png'
                        alt='Logo'
                        width={64}
                        height={17}
                ...
                <div className='flex-1 flex relative min-w-0'>
                  ...
                  <div className='xl:relative flex flex-col xl:flex-row xl:items-start justify-between gap-4 xl:gap-3 p-4 xl:p-0 w-full bg-figma-primary-0 xl:bg-transparent'>
