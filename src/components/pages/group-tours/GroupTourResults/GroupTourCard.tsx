    ...
    >
      <div className='flex items-end relative isolate w-full'>
        ...
        <div className='relative flex flex-1 min-w-0'>
          ...
          <div className='xl:bg-white flex flex-col justify-between min-w-0 relative xl:gap-7 xl:pl-8 xl:pr-5 xl:py-5 transition-all duration-300 xl:group-hover:pl-10'>
