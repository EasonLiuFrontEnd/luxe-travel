    ...
    <div>
      ...
      <div className='flex flex-col gap-y-5 p-7 rounded-2xl bg-figma-neutral-0'>
        ...
        <div className='flex gap-x-2 items-center font-genseki-body-m-medium text-figma-primary-500 p-7 rounded-2xl bg-figma-secondary-150'>
          ...
          >
            <path
              d='M6 18L8 18L13 10.4211L18.5 10.4211C19.33 10.4211 20 9.78632 20 9C20 8.21368 19.33 7.57895 18.5 7.57895L13 7.57895L8 -5.24537e-07L6 -6.11959e-07L8.5 7.57895L3 7.57895L1.5 5.68421L0 5.68421L1 9L0 12.3158L1.5 12.3158L3 10.4211L8.5 10.4211L6 18Z'
              fill='#926D3C'
            />
          </svg>
