    ...
    <div className='flex max-xl:flex-col max-xl:gap-y-9 mx-[20px] xl:mx-[240px]'>
      <div className='order-2 xl:order-1 flex flex-col'>
        <Image
          ...
          width={732}
          height={440}
          className='max-xl:self-end mb-9 max-xl:pl-10 xl:mb-12 rounded-2xl object-cover'
        />
        <Image
          key='hotel-inside-2'
          ...
          className='mb-10 max-xl:pr-10 xl:mb-[52px] rounded-2xl object-cover'
        />
      </div>
      <div className='order-1 xl:order-2 xl:w-[587px] xl:mt-[75px] xl:ml-[121px]'>
        <h3 className='relative text-center font-family-noto-serif text-[24px] xl:text-[40px] font-bold leading-[1.2] text-figma-secondary-500'>
          別再陷入
          <br />
