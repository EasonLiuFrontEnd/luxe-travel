...
const TimeSlotCard = ({ slot }: { slot: TTimeSlot }) => {
  const isDisabled = slot.status === '已滿團'
  ...
  return (
    ...
    >
      <div className={`flex flex-col items-center rounded-[4px] w-[84px] ${
        isDisabled ? disabledStyles.container : activeStyles.container
      }`}>
        <p className={`w-full font-noto-serif-body-m-medium text-center py-2 border-b ${
