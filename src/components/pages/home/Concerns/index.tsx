...
const Concerns = () => {
  ...
  return (
    ...
    >
      <h2
        className='font-noto-serif-tc font-bold text-[32px] lg:text-[64px] lg:leading-[1.2] text-figma-primary-950 py-[6px] px-[12px] text-center'
      >
        {isMobile ? (
          <>
      ...
      <div className="flex flex-wrap max-lg:flex-col justify-center items-start gap-8">
