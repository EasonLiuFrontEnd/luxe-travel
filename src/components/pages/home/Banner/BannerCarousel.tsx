...
const BannerCarousel = ({
  ...
  return (
    ...
    >
      <CarouselContent>
        {images.map((image, index) => (
          <CarouselItem key={index}>
            <div
              className={cn(
                'h-[460px] lg:h-[662px] relative rounded-2xl overflow-hidden',
                className,
              )}
            >
              <Image
      ...
      <div className='absolute bottom-0 max-lg:right-0 lg:left-0'>
        <button
          className={cn(
            'flex items-center cursor-pointer',
            'bg-figma-neutral-50 text-figma-secondary-950',
            'max-lg:rounded-ss-xl lg:rounded-se-2xl',
            'font-noto-serif-tc font-bold lg:text-[32px] lg:leading-[1.5] text-[24px] leading-[1.2]',
            'py-[8px] px-[12px]',
            'lg:py-[11px] lg:px-[32px]',
        ...
        >
          ...
          <svg
            ...
            viewBox='0 0 76 38'
            fill='none'
            className={cn(styles['arrow'], 'hidden lg:block')}
          >
            <path
          ...
          <svg
            ...
            viewBox='0 0 25 9'
            fill='none'
            className={cn(styles['arrow'], 'block lg:hidden m-[4px] ml-[12px]')}
          >
            <path
      ...
      <div className='absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center space-x-4 z-10'>
        <button
          ...
          className={cn(
            'max-lg:hidden w-[32px] h-[32px] rounded-full cursor-pointer',
        ...
        <div className='max-lg:hidden font-genseki-h5-medium text-figma-neutral-0'>
