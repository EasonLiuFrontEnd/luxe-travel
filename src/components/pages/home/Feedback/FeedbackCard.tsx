...
const FeedbackCard = () => {
  ...
  return (
    <div
      className={`relative flex flex-col items-center w-[523px] pt-[103px] pb-[24px] px-[24px] bg-figma-neutral-0 ${isExpanded ? 'max-h-[714px]' : 'max-h-[374px]'}`}
    >
      ...
      <p
        className={`mb-[20px] ${isExpanded ? '' : 'line-clamp-6'} overflow-hidden`}
      >
