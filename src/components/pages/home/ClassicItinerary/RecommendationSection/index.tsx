...
const RecommendationSection = () => {
  return (
    <div className='recommendation-section bg-[var(--color-figma-primary-50)] relative z-10 box-border flex justify-center pt-[32px] pb-[60px] xl:py-20 px-[clamp(12px,2.5vw,48px)] border-y border-[var(--color-figma-secondary-500)]'>
